        ...
        <div class="row justify-content-center">
            <div class="pt-4 col-md-6 p-3 border border-1 border-warning bg-white shadow rounded bg-body">
                <div class="text-center">
                    <h2 class="text-white bg-danger py-2">Send Birthday Gift</h2>
                </div>

                <div class="form-floating mb-3">
                    <select class="form-select" aria-label="Default select example" id="biller">
                    <option value="Electricity Bill">Birthday Gift</option>
                    </select>
                    <label for="id="utype"">Payment Type:</label>
                    </div>
                  ...
                  <div class="form-floating mb-3">
                      ...
                      <label for="amount">Enter Amount to Gift</label>
                  </div>
